return function()
  ...
  local color_map = {
    ...
    darkred = { index = 8, default = "#a31738" },
  }
  ...
  local sl_colors = {
    ...
    White   = { fg = pal.white,   bg = pal.black },
		...
		local groups = {
			...
			UserSLAlt = pal.sl,
			UserSLAltSep = { fg = pal.sl.bg, bg = pal.sl.bg },
			UserSLGitBranch = { fg = pal.cyan, bg = pal.sl.bg },

			DiagnosticUnderlineError = { fg = nil, bg = nil, sp = nil },
			DiagnosticUnderlineHint = { fg = nil, bg = nil, sp = nil },
			DiagnosticUnderlineInfo = { fg = nil, bg = nil, sp = nil },
			DiagnosticUnderlineWarn = { fg = nil, bg = nil, sp = nil },
		}
